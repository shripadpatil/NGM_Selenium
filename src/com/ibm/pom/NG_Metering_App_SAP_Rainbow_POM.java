...
public class NG_Metering_App_SAP_Rainbow_POM {
	private WebDriver driver; 
	private GenericMethods genericMethods = new GenericMethods(driver);
	
	public NG_Metering_App_SAP_Rainbow_POM(WebDriver driver) {
		this.driver = driver; 
	...
	@FindBy(css="#_createworkrequest_WAR_CreateWorkRequest100_manufacturerSn")  
